...
### 16. Sync API + sequential tests; bounded I/O-phase threading (ADR-0002, ADR-0020, ADR-0018)
...
What ADR-0020 narrows: the orchestration **I/O phases** (bring-up uploads,
